...
class ArraysTest < Minitest::Test
  ...
  def test_4
    ...
    assert_equal ["Germany", "Mexico", "Iceland", "Portugal", "Brazil"], world_cup.insert(4, "Brazil")

    # Use a different method to add the element "Japan" to the end of the array
    assert_equal ["Germany", "Mexico", "Iceland", "Portugal","Brazil", "Japan"], world_cup.push("Japan")
  end
  ...
  def test_b
    ...
    assert_equal ["Vocals", "Guitar", "Drums", "Bass"], band.insert(0, "Vocals")
  end
  ...
  def test_10
    ...
    assert_equal ["a", "e", "i", "o", "u"], vowels.reject {|i| i == "y"}
  end
